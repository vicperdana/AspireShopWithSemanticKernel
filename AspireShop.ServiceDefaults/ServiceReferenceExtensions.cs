...
public static class ServiceReferenceExtensions
{
    ...
    /// <param name="healthRelativePath"></param>
    /// <returns></returns>
    ...
    public static IHttpClientBuilder AddHttpServiceReference<TClient>(this IServiceCollection services,
        string baseAddress, string healthRelativePath)
        where TClient : class
    {
    ...
    public static IHttpClientBuilder AddHttpServiceReference<TClient>(this IServiceCollection services,
        string baseAddress, string healthRelativePath, int TimeoutSeconds, string? healthCheckName = default,
